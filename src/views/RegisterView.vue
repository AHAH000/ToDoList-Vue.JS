...
const handleSubmit = async () => {
  ...
  try {
    await axios.post('https://todo.nafistech.com/api/register', {
...
<template>
  ...
  .multi-step-form {
      ...
      min-height: 80vh; /* Reduced height to make the form shorter */
      background-color: black; /* Background color for the form */
  ...
  button {
    ...
    background-color: green; /* Background color for buttons */
    ...
    transition: background-color 0.3s ease, transform 0.3s ease; /* Smoot*/
  }
  
  button:hover {
      background-color: darkgreen; /* Darker button color on hover */
...
label{
  ...
  .circle.active {
      background-color: green; /* Color of the active circle */
      color: white;
  }
